     ...
     <li class="topMenuLi">
      ...
      <a class = "menuLink" href="#">이달의베스트</a>
   	...
   	<div class="container">
			...
			<thead>
			<tr>
				<th colspan="3" style="background-clor:#eeeeee; text-align:center;">게시판 글 보기</th>
			</tr>
			</thead>
				<tbody>
				<tr>
				...
				<tr>
					<td >내용 </td>
					<td colspan="2" style="min-height:300px; text-align: left"><%= bbs.getBbsContent().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt").replaceAll("\n","<br>") %></td> 					
				</tr>
